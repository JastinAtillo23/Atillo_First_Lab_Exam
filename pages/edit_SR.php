...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .student-badge span { color: var(--muted); }
  ...
  .field input::placeholder { color: rgba(143,160,188,0.4); }
...
<div class="wrapper">
  ...
  <div class="card">
    <div class="card-header">
      <h1>Edit Student</h1>
      <p>Update enrollment entry</p>
    </div>

    <?php if($row): ?>
    <div class="student-badge">
      <span>Editing:</span> <?php echo htmlspecialchars($row['full_name']); ?>
    </div>
    <?php endif; ?>
    ...
    <form method="POST">
      <div class="field">
        ...
        <input type="text" id="student_id" name="student_id"
               value="<?php echo htmlspecialchars($row['ID_number']); ?>">
      </div>
